...
function getVue3TitleMap() {
  ...
  titleMapCache = {};
  try {
    const raw = '{"pages/login/login":"登录","pages/login/register":"注册","pages/login/resetPassword":"重置密码","pages/home/index":"涉外案例查询","pages/case/list":"案例检索","pages/case/detail":"案例详情","pages/law/list":"法律条文","pages/law/detail":"法律详情","pages/study/index":"海外法律知识","pages/favorite/index":"我的收藏","pages/history/index":"浏览记录","pages/user/index":"个人中心"}';
...
const STAT_VERSION_PUBLIC = "5.21";
...
function getAppId$1() {
  var _a;
  return (_a = "__UNI__FRCS") !== null && _a !== void 0 ? _a : "";
}
...
function getEnvAppName() {
  var _a;
  return (_a = "涉外案例查询与法律知识系统") !== null && _a !== void 0 ? _a : "";
}
